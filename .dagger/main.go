// A generated module for DBMigrator functions
//
...
import (
	...
	"github.com/cryptellation/dbmigrator/dagger/internal/dagger"
)

type DBMigrator struct{}

// Publish a new release.
func (ci *DBMigrator) PublishTag(
	ctx context.Context,
...
func (ci *DBMigrator) Lint(sourceDir *dagger.Directory) *dagger.Container {
	c := dag.Container().
...
func (ci *DBMigrator) LintDagger(sourceDir *dagger.Directory) *dagger.Container {
	c := dag.Container().
		From("golangci/golangci-lint:v1.62.0").
		WithMountedCache("/root/.cache/golangci-lint", dag.CacheVolume("golangci-lint"))
...
func (ci *DBMigrator) UnitTests(sourceDir *dagger.Directory) *dagger.Container {
...
func (ci *DBMigrator) withGoCodeAndCacheAsWorkDirectory(
	c *dagger.Container,
	sourceDir *dagger.Directory,
) *dagger.Container {
	containerPath := "/go/src/github.com/cryptellation/dbmigrator"
	return c.
		// Add Go caches
