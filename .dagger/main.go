...
func (mod *DBMigrator) Lint(sourceDir *dagger.Directory) *dagger.Container {
	c := dag.Container().
...
func (mod *DBMigrator) UnitTests(sourceDir *dagger.Directory) *dagger.Container {
...
func (mod *DBMigrator) withGoCodeAndCacheAsWorkDirectory(
	c *dagger.Container,
	sourceDir *dagger.Directory,
) *dagger.Container {
